...
namespace Xande.Common.Materials
{
    public class Material
    {
        ...
        /// </summary>
        public Common.Models.Model Parent { get; private set; }
        ...
        /// This constructor is used by the <see cref="parent"/> class to
        /// provide a reference to the model within the material.
        /// </summary>
        /// <param name="path">The Model this Material has been instantiated for.</param>
        /// <param name="variantId">The path, relative or absolute, to this Material.</param>
        /// <param name="variantId">The variant ID for this material. Default is 1.</param>
        public Material( Common.Models.Model parent, string path, int variantId = 1 )
        {
            Parent = parent;
            MaterialPath = path;
            VariantId = variantId;
