...
public class Shape {
    ...
    public Shape( Common.Models.Model model, Common.Models.Model.ModelLod lod, IReadOnlyList< ShapeMesh > shapeMeshes, int shapeIndex )
    {
